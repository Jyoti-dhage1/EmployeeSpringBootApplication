package com.springboot.EmployeeSpringBootApplication.entity;
...
public class Employee2 {
	...
	public Employee2(int id, String name, String phoneno, String departmentit, String status, String createddtm,
	...
	public String toString() {
		return "Employee2 [id=" + id + ", name=" + name + ", phoneno=" + phoneno + ", departmentit=" + departmentit
